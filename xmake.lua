...
-- Diagnostic build: raises the mod's logger to Debug so hover / extraction /
-- render diagnostics show up in LeviLamina's log. Off by default.
option("trace")
    set_default(false)
    set_showmenu(true)
